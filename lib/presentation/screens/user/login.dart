...
// ---------------- EMAIL VALIDATION + BUTTON ENABLE/DISABLE HERE ---------------- //
...
class _SignInFormState extends State<SignInForm> {
  ...
  bool get isFormFilled => email.isNotEmpty && password.isNotEmpty;
    ...
    return Form(
      ...
      child: Column(
        children: [
          ...
          // ---------------- CONTINUE BUTTON ---------------- //
          Opacity(
            opacity: isFormFilled ? 1.0 : 0.4,
            child: ElevatedButton(
              onPressed: isFormFilled
                  ? () {
                      if (_formKey.currentState!.validate()) {
                        print("LOGIN SUCCESS — form valid");
                      }
                    }
                  : null,
...
// ---------------------------- ICONS ----------------------------- //
// (Keeping your icon SVGs unchanged)
